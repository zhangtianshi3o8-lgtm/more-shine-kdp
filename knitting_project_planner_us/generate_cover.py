#!/usr/bin/env python3
"""
Knitting Project Planner -- KDP Full Wrap Cover Generator
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "knitting_project_planner_us_cover_V1.0.html")
...
<head>
  ...
  <title>Knitting Project Planner -- Cover</title>
  {CSS}
</head>
<body>
<div class="cover-wrap">
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        <strong>Cast on with confidence. Finish every project.</strong>
        Whether you knit sweaters, scarves, socks, hats, blankets,
        or gifts, this planner helps you track every project from
        first stitch to final bind-off. Stay organized, record
        what works, and never lose track of a pattern or gauge
        swatch again.
      </div>
      ...
      <ul class="back-features">
        <li>25 two-page project spreads with gauge swatch</li>
        <li>Yarn, needle, and pattern tracking per project</li>
        <li>5 progress review pages with habit tracker</li>
        <li>Knitting goals page to set your targets</li>
        <li>Needle and hook inventory section</li>
        <li>Yarn stash tracker by weight and yardage</li>
        <li>Pattern wishlist and handknit gift log</li>
  ...
  <div class="spine">
    ...
    <div class="spine-text">Knitting Project Planner</div>
  </div>
    ...
    <div class="icon-wrap">
      <svg viewBox="0 0 110 110" width="110" height="110" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(55,55)">
          <!-- Needle 1 (diagonal) -->
          <line x1="-38" y1="32" x2="32" y2="-36" stroke="{C_AMBER}" stroke-width="2.5" stroke-linecap="round"/>
          <!-- Needle 1 tip ball -->
          <circle cx="32" cy="-36" r="3" fill="{C_GOLD}"/>
          <!-- Needle 2 (diagonal opposite) -->
          <line x1="38" y1="32" x2="-32" y2="-36" stroke="{C_AMBER}" stroke-width="2.5" stroke-linecap="round"/>
          <!-- Needle 2 tip ball -->
          <circle cx="-32" cy="-36" r="3" fill="{C_GOLD}"/>
          <!-- Yarn ball (center) -->
          <circle cx="0" cy="0" r="16" stroke="{C_AMBER}" stroke-width="2.5" fill="none"/>
          <path d="M -12,-7 Q 0,-12 11,-5" stroke="{C_GOLD}" stroke-width="1.8" fill="none"/>
          <path d="M -9,3 Q 3,9 10,-1" stroke="{C_GOLD}" stroke-width="1.8" fill="none"/>
          <path d="M -6,10 Q 4,5 8,11" stroke="{C_AMBER}" stroke-width="1.5" fill="none"/>
          <!-- Yarn strand trailing off -->
          <path d="M 16,0 Q 32,4 40,-10 Q 46,-20 38,-26" stroke="{C_AMBER}" stroke-width="2" fill="none" stroke-linecap="round"/>
          <!-- Small stitch detail on strand -->
          <circle cx="36" cy="-18" r="1.5" fill="{C_GOLD}"/>
        </g>
      </svg>
    </div>
    <div class="title-block">
      <div class="main-title">Knitting<br>Project<br>Planner</div>
      <div class="accent-bar"></div>
      <div class="subtitle">Track Every Stitch,<br>Finish Every Project</div>
      <div class="features">
        <span class="feature-badge">25 Projects</span>
        <span class="feature-badge">Gauge Tracker</span>
        <span class="feature-badge">Stash Log</span>
        <span class="feature-badge">Gift Log</span>
      </div>
      <div class="tagline">For Knitters &amp; Makers</div>
    </div>
