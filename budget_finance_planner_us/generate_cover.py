#!/usr/bin/env python3
"""
Budget & Finance Planner — KDP Full Wrap Cover Generator
Zero-dependency (Python stdlib only).

Trim: 6" x 9"
Pages: 53 (cream paper)
Spine: 53 x 0.0025 = 0.1325"
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "budget_finance_planner_us_cover_V1.0.html")
...
<head>
  ...
  <title>Budget &amp; Finance Planner &mdash; Cover</title>
  {CSS}
</head>
<body>
<div class="cover-wrap">
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        <strong>Take control of your money, one month at a time.</strong>
        This budget and finance planner gives you the tools to plan,
        track, and achieve your financial goals. With 12 monthly budget
        spreads, weekly expense trackers, savings goals, debt payoff
        tools, and a net worth statement, it is everything you need to
      ...
      <ul class="back-features">
        <li>12 monthly two-page budget spreads with income and expenses</li>
        <li>6 weekly expense trackers for detailed spending logs</li>
        <li>Savings goals tracker with visual progress bars</li>
        <li>Debt payoff tracker using the snowball method</li>
        <li>Bills and subscription tracker with auto-pay flags</li>
        <li>Annual overview and year-end financial review</li>
        <li>Net worth statement and financial goals pages</li>
  ...
  <div class="spine">
    ...
    <div class="spine-text">Budget &amp; Finance Planner</div>
  </div>

  <!-- ============ FRONT COVER ============ -->
  <div class="front-cover">

    <!-- Dollar / Coin SVG Icon -->
    <div class="icon-wrap">
      <svg viewBox="0 0 120 120" width="120" height="120" xmlns="http://www.w3.org/2000/svg">
        <!-- Outer dashed arc -->
        <circle cx="60" cy="60" r="56" stroke="{C_GOLD}" stroke-width="1" fill="none" opacity="0.15" stroke-dasharray="4,4"/>
        <!-- Outer circle -->
        <circle cx="60" cy="60" r="46" stroke="{C_GOLD}" stroke-width="2" fill="none" opacity="0.5"/>
        <!-- Inner circle -->
        <circle cx="60" cy="60" r="36" stroke="{C_GOLD}" stroke-width="1" fill="none" opacity="0.3"/>
        <!-- Dollar sign -->
        <text x="60" y="78" text-anchor="middle" font-family="Georgia, serif" font-size="52" font-weight="700" fill="{C_GOLD}" opacity="0.6">$</text>
      </svg>
    </div>

    <!-- Title -->
    <div class="title-block">
      <div class="main-title">Budget &amp;<br>Finance Planner</div>
      <div class="accent-bar"></div>
      <div class="subtitle">Take Control of Your Money,<br>One Month at a Time</div>
      <div class="features">
        <span class="feature-badge">12 Months</span>
        <span class="feature-badge">Savings Goals</span>
        <span class="feature-badge">Debt Payoff</span>
        <span class="feature-badge">Net Worth</span>
      </div>
      <div class="tagline">Plan &middot; Track &middot; Save &middot; Achieve</div>
    </div>
