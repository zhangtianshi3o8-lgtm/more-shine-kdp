#!/usr/bin/env python3
"""
Meal Planner & Grocery — KDP Full Wrap Cover Generator
Zero-dependency (Python stdlib only).

Trim: 6" x 9"
Pages: 111 (cream paper)
Spine: 111 x 0.0025 = 0.2775"
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "meal_planner_grocery_us_cover_V1.0.html")
...
<head>
  ...
  <title>Meal Planner &amp; Grocery — Cover</title>
  {CSS}
</head>
<body>
<div class="cover-wrap">
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        <strong>Plan smart. Eat well. Stress less.</strong>
        This weekly meal planner and grocery list makes healthy eating
        simple. Plan all seven days of breakfast, lunch, and dinner at a
        glance, then shop with confidence using the organized grocery list.
      </div>
      ...
      <ul class="back-features">
        <li>52 weekly meal plan spreads (7 days x 3 meals)</li>
        <li>52 organized grocery shopping lists</li>
        <li>Snack tracker and daily water intake circles</li>
        <li>Budget tracker for each shopping trip</li>
        <li>Pantry staples checklist to get you started</li>
        <li>Notes and favorite recipes pages</li>
  ...
  <div class="spine">
    ...
    <div class="spine-text">Meal Planner &amp; Grocery</div>
  </div>
  ...
  <div class="front-cover">
    ...
    <div class="plate-wrap">
      <svg viewBox="0 0 120 120" width="120" height="120" xmlns="http://www.w3.org/2000/svg">
        <!-- Plate -->
        <circle cx="60" cy="62" r="32" stroke="{C_GOLD}" stroke-width="1.5" fill="none"/>
        <circle cx="60" cy="62" r="26" stroke="{C_GOLD}" stroke-width="1" fill="none" opacity="0.4"/>
        <!-- Fork -->
        <line x1="22" y1="28" x2="22" y2="85" stroke="{C_GOLD}" stroke-width="1.5"/>
        <line x1="19" y1="28" x2="19" y2="40" stroke="{C_GOLD}" stroke-width="1"/>
        <line x1="22" y1="28" x2="22" y2="40" stroke="{C_GOLD}" stroke-width="1"/>
        <line x1="25" y1="28" x2="25" y2="40" stroke="{C_GOLD}" stroke-width="1"/>
        <!-- Knife -->
        <line x1="98" y1="28" x2="98" y2="85" stroke="{C_GOLD}" stroke-width="1.5"/>
        <path d="M 94 28 L 102 28 L 98 42 Z" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
      </svg>
    </div>

    <!-- Title -->
    <div class="title-block">
      <div class="main-title">Meal Planner<br>&amp; Grocery</div>
      <div class="accent-bar"></div>
      <div class="subtitle">52 Weeks of Healthy Eating<br>Made Simple</div>
      <div class="features">
        <span class="feature-badge">52 Weekly Plans</span>
        <span class="feature-badge">Grocery Lists</span>
        <span class="feature-badge">Budget Tracker</span>
        <span class="feature-badge">Water Tracker</span>
      </div>
      <div class="tagline">Plan &middot; Shop &middot; Cook &middot; Enjoy</div>
    </div>
