#!/usr/bin/env python3
"""
Travel Journal & Trip Planner — KDP Full Wrap Cover Generator
Zero-dependency (Python stdlib only).

Trim: 6" x 9"
Pages: 57 (cream paper)
Spine: 57 x 0.0025 = 0.1425"
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "travel_journal_trip_planner_us_cover_V1.0.html")
...
<head>
  ...
  <title>Travel Journal &amp; Trip Planner &mdash; Cover</title>
  {CSS}
</head>
<body>
<div class="cover-wrap">
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        <strong>Plan your adventures and capture every journey.</strong>
        This travel journal gives you the space to plan trips before you
        go and record every moment while you're there. With 20 two-page
        trip logs, a bucket list, packing checklists, budget trackers,
        and a countries-visited page, it's everything a traveler needs
        to turn fleeting experiences into lasting memories.
      </div>
      ...
      <ul class="back-features">
        <li>20 two-page trip log spreads with budget tracker</li>
        <li>Travel bucket list with priority rankings</li>
        <li>Pre-trip planning checklist</li>
        <li>Packing list with four categories</li>
        <li>Countries visited tracker with highlights</li>
        <li>World continents reference guide</li>
  ...
  <div class="spine">
    ...
    <div class="spine-text">Travel Journal &amp; Trip Planner</div>
  </div>
  ...
  <div class="front-cover">
    ...
    <div class="icon-wrap">
      <svg viewBox="0 0 120 120" width="120" height="120" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Compass outer ring -->
        <circle cx="60" cy="60" r="48" stroke="{C_GOLD}" stroke-width="1.5" fill="rgba(196,160,74,0.04)"/>
        <circle cx="60" cy="60" r="38" stroke="{C_GOLD}" stroke-width="0.8" fill="none" opacity="0.3"/>
        <!-- Compass marks -->
        <line x1="60" y1="14" x2="60" y2="24" stroke="{C_GOLD}" stroke-width="1.2"/>
        <line x1="60" y1="96" x2="60" y2="106" stroke="{C_GOLD}" stroke-width="0.8"/>
        <line x1="14" y1="60" x2="24" y2="60" stroke="{C_GOLD}" stroke-width="0.8"/>
        <line x1="96" y1="60" x2="106" y2="60" stroke="{C_GOLD}" stroke-width="0.8"/>
        <!-- N/S/E/W labels -->
        <text x="60" y="34" text-anchor="middle" font-size="7" fill="{C_GOLD}" font-family="Georgia" font-weight="bold">N</text>
        <text x="60" y="90" text-anchor="middle" font-size="6" fill="{C_GOLD}" opacity="0.5" font-family="Georgia">S</text>
        <text x="34" y="63" text-anchor="middle" font-size="6" fill="{C_GOLD}" opacity="0.5" font-family="Georgia">W</text>
        <text x="86" y="63" text-anchor="middle" font-size="6" fill="{C_GOLD}" opacity="0.5" font-family="Georgia">E</text>
        <!-- Compass needle -->
        <path d="M 60 28 L 66 60 L 60 92 L 54 60 Z" stroke="{C_GOLD}" stroke-width="1" fill="rgba(196,160,74,0.15)"/>
        <path d="M 60 28 L 66 60 L 54 60 Z" stroke="{C_GOLD}" stroke-width="1" fill="rgba(196,160,74,0.35)"/>
        <!-- Center -->
        <circle cx="60" cy="60" r="4" fill="{C_GOLD}"/>
    ...
    <div class="title-block">
      <div class="main-title">Travel Journal<br>&amp; Trip Planner</div>
      <div class="accent-bar"></div>
      <div class="subtitle">Plan Your Adventures<br>and Capture Every Journey</div>
      <div class="features">
