#!/usr/bin/env python3
"""
Cat Memorial Journal — KDP Full Wrap Cover Generator
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "cat_memorial_journal_us_cover_V1.0.html")
...
C_CHARCOAL = "#161616"   # near-black warm charcoal
C_DARK     = "#1C1C1C"   # slightly lighter charcoal
C_WARM_D   = "#221E1B"   # deep brown-charcoal
C_MAUVE    = "#8B7B8A"   # soft mauve accent
...
<head>
  ...
  <title>In Loving Memory of My Cat — Cover</title>
  {CSS}
</head>
<body>
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        ...
        the life of a beloved cat &mdash; to remember their quirks,
      ...
      <ul class="back-features">
        <li>Guided profile pages for your cat's story and personality</li>
