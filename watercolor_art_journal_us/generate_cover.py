#!/usr/bin/env python3
"""
Watercolor & Art Journal — KDP Full Wrap Cover Generator
Zero-dependency (Python stdlib only).

Trim: 6" x 9"
Pages: 113 (cream paper)
Spine: 113 x 0.0025 = 0.2825"
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "watercolor_art_journal_us_cover_V1.0.html")
...
<head>
  ...
  <title>Watercolor &amp; Art Journal &mdash; Cover</title>
  {CSS}
</head>
<body>
<div class="cover-wrap">
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        <strong>Where every blank page becomes a possibility.</strong>
        This watercolor and art journal gives you the space to paint,
        sketch, and create without limits. Dot grid pages guide your
        composition, grid pages sharpen your technique, and blank
        pages invite pure creative freedom.
      </div>
      ...
      <ul class="back-features">
        <li>Dot grid canvas pages for guided sketching</li>
        <li>Light grid pages for drawing and perspective practice</li>
        <li>Blank canvas pages for finished artwork</li>
        <li>Artwork log pages to track medium, colors, and techniques</li>
        <li>Color theory and watercolor techniques reference</li>
        <li>A&ndash;Z artwork index for quick lookup</li>
        <li>Large 6&quot; x 9&quot; format &mdash; easy to paint in</li>
      </ul>
    </div>
  ...
  <div class="spine">
    ...
    <div class="spine-text">Watercolor &amp; Art Journal</div>
  </div>
  ...
  <div class="front-cover">
    ...
    <div class="palette-wrap">
      <svg viewBox="0 0 120 120" width="120" height="120" xmlns="http://www.w3.org/2000/svg">
        <!-- Palette -->
        <ellipse cx="55" cy="68" rx="40" ry="24" stroke="{C_GOLD}" stroke-width="1.5" fill="none"/>
        <!-- Paint wells -->
        <circle cx="38" cy="60" r="6" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
        <circle cx="52" cy="54" r="6" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
        <circle cx="68" cy="56" r="6" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
        <circle cx="60" cy="72" r="6" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
        <circle cx="44" cy="74" r="6" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
        <!-- Thumb hole -->
        <ellipse cx="75" cy="68" rx="5" ry="4" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
        <!-- Brush -->
        <line x1="88" y1="35" x2="102" y2="18" stroke="{C_GOLD}" stroke-width="2"/>
        <ellipse cx="87" cy="36" rx="3.5" ry="6" stroke="{C_GOLD}" stroke-width="1" fill="none" transform="rotate(-50 87 36)"/>
        <!-- Brush handle end -->
        <circle cx="103" cy="16" r="2.5" stroke="{C_GOLD}" stroke-width="1" fill="none"/>
      </svg>
    </div>

    <!-- Title -->
    <div class="title-block">
      <div class="main-title">Watercolor<br>&amp; Art Journal</div>
      <div class="accent-bar"></div>
      <div class="subtitle">A Sketchbook for Painting,<br>Drawing, and Creative Expression</div>
      <div class="features">
        <span class="feature-badge">96 Canvas Pages</span>
        <span class="feature-badge">Dot &amp; Grid</span>
        <span class="feature-badge">Art Log</span>
        <span class="feature-badge">Color Guide</span>
      </div>
      <div class="tagline">Paint &middot; Sketch &middot; Create &middot; Inspire</div>
    </div>
