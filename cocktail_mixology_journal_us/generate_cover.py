#!/usr/bin/env python3
"""
Cocktail Mixology Journal — KDP Full Wrap Cover Generator
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "cocktail_mixology_journal_us_cover_V1.0.html")
...
<head>
  ...
  <title>Cocktail Mixology Journal &mdash; Cover</title>
  {CSS}
</head>
<body>
<div class="cover-wrap">
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        <strong>Craft, record, and perfect every drink you make.</strong>
        This cocktail journal gives you the space to develop your
        mixology skills and build a personal repertoire of signature
        drinks. With dedicated recipe pages, a flavor wheel, classic
        recipes, and a home bar inventory, it is everything you need
        to elevate your home bartending.
      </div>
      ...
      <ul class="back-features">
        <li>40 two-page recipe spreads with ingredients and ratings</li>
        <li>Flavor balance scale (sweet, sour, boozy, bitter)</li>
        <li>12 classic cocktail recipes with measurements</li>
        <li>Base spirits, techniques, and glassware reference</li>
        <li>Home bar inventory with stock-level tracking</li>
        <li>Equipment and glassware collection checklists</li>
  ...
  <div class="spine">
    ...
    <div class="spine-text">Cocktail Mixology Journal</div>
  </div>
  ...
  <div class="front-cover">
    ...
    <div class="glass-wrap">
      <svg viewBox="0 0 120 140" width="120" height="140" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M 20 20 L 100 20 L 62 85 L 58 85 Z" stroke="{C_GOLD}" stroke-width="1.5" fill="none"/>
        <!-- Liquid inside -->
        <path d="M 28 28 L 92 28 L 63 75 L 57 75 Z" stroke="none" fill="{C_GOLD}" opacity="0.12"/>
        <!-- Liquid surface highlight -->
        <ellipse cx="60" cy="28" rx="32" ry="2" fill="{C_GOLD}" opacity="0.3"/>
        <!-- Olive pick -->
        <line x1="70" y1="22" x2="78" y2="55" stroke="{C_GOLD}" stroke-width="1" opacity="0.6"/>
        <circle cx="76" cy="48" r="4" stroke="{C_GOLD}" stroke-width="1" fill="none" opacity="0.5"/>
        <!-- Stem -->
        <line x1="60" y1="85" x2="60" y2="120" stroke="{C_GOLD}" stroke-width="1.5"/>
        <!-- Base -->
        <ellipse cx="60" cy="123" rx="22" ry="4" stroke="{C_GOLD}" stroke-width="1.5" fill="none"/>
        <!-- Base shadow -->
        <ellipse cx="60" cy="126" rx="18" ry="2" fill="{C_GOLD}" opacity="0.1"/>
      </svg>
    </div>

    <!-- Title -->
    <div class="title-block">
      <div class="main-title">Cocktail<br>Mixology Journal</div>
      <div class="accent-bar"></div>
      <div class="subtitle">Craft, Record, and Perfect<br>Every Drink You Make</div>
      <div class="features">
        <span class="feature-badge">40 Recipes</span>
        <span class="feature-badge">Classics Guide</span>
        <span class="feature-badge">Bar Inventory</span>
        <span class="feature-badge">Flavor Wheel</span>
      </div>
      <div class="tagline">Mix &middot; Shake &middot; Pour &middot; Enjoy</div>
    </div>
