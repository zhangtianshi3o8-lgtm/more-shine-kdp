#!/usr/bin/env python3
"""
Family Recipe Journal — KDP Full Wrap Cover Generator
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "family_recipe_journal_us_cover_V1.0.html")
...
<head>
  ...
  <title>Family Recipe Journal &mdash; Cover</title>
  {CSS}
</head>
<body>
<div class="cover-wrap">
  ...
  <div class="back-cover">
    <div class="back-text">
      <div class="blurb">
        <strong>Preserve the recipes that bring your family together.</strong>
        This beautifully designed recipe journal gives you a place to write
        down every cherished dish &mdash; from Grandma's secret sauce to
        your own weeknight favorites. Each two-page spread keeps
        ingredients, directions, ratings, and notes beautifully organized.
      </div>
      ...
      <ul class="back-features">
        <li>50 two-page recipe spreads with generous writing space</li>
        <li>Recipe index organized A&ndash;Z for quick lookup</li>
        <li>Ingredients list with check boxes for mise en place</li>
        <li>Star rating, difficulty, prep &amp; cook time fields</li>
        <li>Measurement equivalents and substitution guide</li>
        <li>Food storage and cooking temperature reference</li>
  ...
  <div class="spine">
    ...
    <div class="spine-text">Family Recipe Journal</div>
  </div>
  ...
  <div class="front-cover">
    ...
    <div class="bowl-wrap">
      <svg viewBox="0 0 120 120" width="120" height="120" xmlns="http://www.w3.org/2000/svg">
        <!-- Steam wisps -->
        <path d="M 42 48 Q 38 35 44 25 Q 50 15 44 5" stroke="{C_GOLD}" stroke-width="1" fill="none" opacity="0.5"/>
        <path d="M 60 45 Q 56 32 62 22 Q 68 12 60 3" stroke="{C_GOLD}" stroke-width="1" fill="none" opacity="0.4"/>
        <path d="M 78 48 Q 74 35 80 25 Q 86 15 80 5" stroke="{C_GOLD}" stroke-width="1" fill="none" opacity="0.5"/>
        <!-- Bowl -->
        <path d="M 18 55 Q 18 88 60 88 Q 102 88 102 55 Z" stroke="{C_GOLD}" stroke-width="1.5" fill="none"/>
        <!-- Bowl rim -->
        <ellipse cx="60" cy="55" rx="42" ry="6" stroke="{C_GOLD}" stroke-width="1.5" fill="none"/>
        <!-- Decorative inner line -->
        <path d="M 28 72 Q 30 82 60 82 Q 90 82 92 72" stroke="{C_GOLD}" stroke-width="0.8" fill="none" opacity="0.4"/>
        <!-- Base -->
        <line x1="52" y1="92" x2="68" y2="92" stroke="{C_GOLD}" stroke-width="1.5"/>
      </svg>
    </div>

    <!-- Title -->
    <div class="title-block">
      <div class="main-title">Family<br>Recipe Journal</div>
      <div class="accent-bar"></div>
      <div class="subtitle">A Heirloom Cookbook to Write Down<br>Your Best Recipes</div>
      <div class="features">
        <span class="feature-badge">50 Recipes</span>
        <span class="feature-badge">A&ndash;Z Index</span>
        <span class="feature-badge">Measures Guide</span>
        <span class="feature-badge">Rating Stars</span>
      </div>
      <div class="tagline">Write &middot; Cook &middot; Share &middot; Remember</div>
    </div>
